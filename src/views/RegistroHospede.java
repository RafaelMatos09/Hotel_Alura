...
public class RegistroHospede extends JFrame {
    ...
    //txtNome _ txtSobrenome _ txtDataN _ txtNacionalidade _  txtTelefone _ txtNreserva _
    private void salvar() {

        if (!txtNome.getText().equals("") && !txtSobrenome.getText().equals("") && !((JTextField) txtDataN.getDateEditor().getUiComponent()).getText().equals("") && !txtNacionalidade.getSelectedItem().toString().equals("") && !txtTelefone.getText().equals("") && !txtNreserva.getText().equals("")) {
            Hospedes hospedes = new Hospedes(txtNome.getText(), txtSobrenome.getText(), ((JTextField) txtDataN.getDateEditor().getUiComponent()).getText(), txtNacionalidade.getSelectedItem().toString(), txtTelefone.getText(), Integer.parseInt(txtNreserva.getText()));
            ...
            JOptionPane.showMessageDialog(this, "Nenhuma campo pode estar vazio!");
        }
