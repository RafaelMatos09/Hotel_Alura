...
public class ReservasView extends JFrame {
    ...
    public ReservasView() {
        ...
        txtDataS.addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent evt) {
                ...
                try {
                    atualizaValor(txtDataE, txtDataS);
    ...
    //txtValor _  txtDataE _ txtDataS _ txtFormaPagamento
    private void salvar() throws ParseException {
        if (!txtDataE.getDate().toString().equals("") && !txtDataS.getDate().toString().equals("") && !txtFormaPagamento.getSelectedItem().equals("")) {
            Reserva reserva = new Reserva(((JTextField) txtDataE.getDateEditor().getUiComponent()).getText(), ((JTextField) txtDataS.getDateEditor().getUiComponent()).getText(), txtFormaPagamento.getSelectedItem().toString());
    ...
    private void atualizaValor(JDateChooser dataEntrada, JDateChooser dataSaida) throws ParseException {
